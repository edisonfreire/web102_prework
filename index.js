...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) { // could also use forEach
...
const totalMoney = GAMES_JSON.reduce( (total, games) => {
...
const str = `A total of $${totalMoney.toLocaleString('en-US')} has been raised for ${totalGames.toLocaleString('en-US')} games. Currently, ${unfunded === 1 ? unfunded + " game" : unfunded + " games"} remain unfunded. We need your help to fund these amazing games!`
...
const firstPledge = document.createElement("p");
firstPledge.innerHTML = `
${first.name}
`;
